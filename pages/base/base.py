...
class Base(object):
    ...
    def __init__(self, driver: webdriver, timeout=30):
        ...
        self.base_url = 'http://fixedserver.test.al8l.com/users/sign_in'
    ...
    def find_element(self, by: str, location: str) -> WebElement:
        ...
        :param by: xpath, id, name,css selector,class with str
    ...
    def get_element_text(self, by: str, location: str) -> (str, None):
        """
        get text of element
        :param by: xpath, id, name, class with str,css selector
        :param location: //*[@by="location"]
        :return: str or bool
        """
        by = by.lower()
